...
class Body{
public:
    Body(Vec3 Velocity, Vec3 Position, double Mass, Vec3 Force = Vec3(), double J2 = 0.0, double RefRadius = 0.0, Vec3 SpinAxis = Vec3(), std::string BodyType = "") 
        : Velocity(Velocity), Position(Position), Mass(Mass), MU(Mass*Constants::G), Force(Force), J2(J2), RefRadius(RefRadius), SpinAxis(SpinAxis), BodyType(BodyType) {}
