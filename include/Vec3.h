...
public:
  ...
  operator+ (const Vec3 &other) const noexcept
  {
  ...
  [[nodiscard]] constexpr Vec3
  operator* (double scalar) const noexcept
  {
  ...
  [[nodiscard]] constexpr bool operator== (const Vec3 &) const noexcept
      = default;
  ...
  {
    return Vec3 (std::fma (y, other.z, -z * other.y),
