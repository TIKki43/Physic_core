...
public:
  Ray () = default;
  Ray (float Wavelength, Vec3 &Position, Vec3 &Direction, float Intensity,
       float WaveSpeed)
      : Wavelength (Wavelength), Position (Position), Direction (Direction),
        Intensity (Intensity), WaveSpeed (WaveSpeed)
  {
  }
  ...
  void InitSchwarzschildMetricState (Body &MassiveBody, float InitialE,
